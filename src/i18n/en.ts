...
export const en: Messages = {
  ...
  chat: {
    ...
    inputPlaceholderCmdEnterCtrl: "Type a message. Ctrl+Enter to send, or @ to reference, # for agents",
  ...
  settings: {
    ...
    uiZoomDesc: "Syncs with the status bar ± buttons and zoom shortcuts",
    ...
    fontCustom: "Custom",
    fontChooseFile: "Choose font file",
    fontPickTitle: "Choose a font file",
    fontFileFilter: "Font files",
    fontErrRead: "The font file could not be read; make sure it still exists.",
    fontErrTooLarge: "The font file is too large (64 MB max).",
    fontErrUnsupported:
    ...
    selfBuiltName: "CC GUI (self-built)",
    selfBuiltDesc: "Self-built version: in-app updates are disabled; upgrades ship with the custom build line.",
